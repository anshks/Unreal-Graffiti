...
bBlob = cv.imread('blackblob.png',-1) # -1 loads with transparency to get the fourth channel
gBlob = cv.imread('greenblob.png',-1)
rBlob = cv.imread('blueblob.png',-1)
...
cv.namedWindow('Paint', cv.WND_PROP_FULLSCREEN)
